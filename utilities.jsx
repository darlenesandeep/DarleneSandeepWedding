...
class Router extends React.Component {
    ...
    //             this.handleRouteEvent(4);
    //         }
    //     })
    // }
    
    // handleQuadrantMouseOver = (item) => this.setState({activeQuadrant: item});

    // handleRouteEvent = (s) => {
    //     var route = 'home';
    //     var transitionDirection = 'clear';
    //     if (s === 0) {
    //         route = 'about';
    ...
    //     }
    //     this.setState({transition: transitionDirection});
    //     setTimeout(() => {
    ...
    // renderTransition() {
    //     return (
    //         <div id="transition" className={this.state.transition}><div id="transition-text-content"></div></div>
    //     );
    // }
    ...
    //     for (var j = 0; j < 4; j++) {
    //         var style = {position: "fixed", top: (j === 0 || j === 1) ? "0%": "50%", left: (j === 0 || j === 3) ? "0%": "50%"};
    //         insides.push(
    //             <div className="menu-group" style={style} key={"menu-group-" + j}>                    
    //                 <div className={"corner corner-" + j }>
    //                         <div className={"quadrant-text quadrant-text-" + j}><div className={"quadrant-text-content-" + j + ((this.state.activeQuadrant === j) ? " active" : "")}>{quadrantText[j]}</div></div>
    //                     </div>
    //             </div>
    //         );
    //     }
    ...
    // renderOutside() {
    //     var quadrantImages = {
    //         0: "https://images.unsplash.com/photo-1623477149936-521ad612590d?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80", // About
    //         1: "https://images.unsplash.com/photo-1545670723-196ed0954986?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1352&q=80", // Work
    //         2: "https://images.unsplash.com/photo-1433840496881-cbd845929862?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1050&q=80", // Skill
    //         3: "https://images.unsplash.com/photo-1528499908559-b8e4e8b89bda?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1352&q=80", // Contact
    //     };

    //     var quadrantStyles = {
    //         0: "translate(47%, 22%) rotate(-45deg) scale(0.5)", // About
    //         1: "translate(-30%, -4%) rotate(-45deg) scale(0.6)", // Work
    //         2: "translate(-47%, -51%) rotate(-45deg) scale(0.5)", // Skill
    //         3: "translate(30%, -23%) rotate(-45deg) scale(0.7)", // Contact
    //     }
    //     const quadrants = [0,1,2,3];
    //     var outsides = [];
    //     var outside = quadrants.map((i) => {
    //         var style = {position: "fixed", top: (i === 0 || i === 1) ? "0%": "50%", left: (i === 0 || i === 3) ? "0%": "50%"};
    //         delay(outsides.push(
    //             <div className={"outside-corner outside-corner-" + i}
    //                 style={style}
    //                 key={i}
    //                 onMouseOver={() => this.handleQuadrantMouseOver(i)}
    //                 onClick={() => this.handleRouteEvent(i)}
    //                 >
    //                 <div className={"cover cover-" + i}></div>
    //                 <img src={quadrantImages[i]} style={{transform: quadrantStyles[i]}}></img>
    //             </div>
    //         ), 1000);
    //     });
